...
1. Remover qualquer biblioteca não utilizada do `package.json`
...
Execute `npm start` para iniciar um servidor de desenvolvimento. Navegue ao `http://localhost:3000/`.
